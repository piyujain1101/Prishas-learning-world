...
function startPicturePhonics() {
    ...
    AudioManager.preloadPicturePhonics();
...
// js/picture-phonics.js
// Replace the existing speakPictureWord function with this:

function speakPictureWord() {
    if (!ppState.currentPicture) return;
    var word = ppState.currentPicture.word;

    // Use dedicated picture phonics audio (generated by sync_audio.py)
    AudioManager.playPicturePhonicsWord(word)
        .catch(function() {
            // Final fallback: try letter-based word audio, then TTS
